// http://answers.unity.com/answers/1333201/view.html
...
namespace MagicBits_OSS.Shared.Scripts
{
    ...
    public class IdGenerator : MonoBehaviour
    {
        ...
        static Dictionary<string, IdGenerator> allGuids = new();
        ...
        // !! Talvez Update() impacte na performance do editor.
        void Update()
        {
            ...
            bool hasSceneNameAtBeginning = (id != null &&
                                            id.Length > sceneName.Length &&
                                            id.Substring(0, sceneName.Length) == sceneName);

            bool anotherComponentAlreadyHasThisID = (id != null &&
                                                     allGuids.ContainsKey(id) &&
                                                     allGuids[id] != this);

            if (!hasSceneNameAtBeginning || anotherComponentAlreadyHasThisID)
            {
                id = sceneName + Guid.NewGuid();
            ...
            // it in our list
            if (!allGuids.ContainsKey(id))
            {
                allGuids.Add(id, this);
            }
        }
